...
const fetchClientOrders = async () => {
  try {
    const response = await axios.get(`${SERVER_URL}/api/get_partner_orders`, {
      withCredentials: true,
    });
...
<template>
    <div class="main_block">
        ...
        <ScrollArea class="border_div" v-if="client_orders.length">
            <div class="head_of_scroll">
                ...
                <span class="lot_number">Компанія</span>
                <span class="lot_name">Телефон</span>
                <span class="lot_name">Вартість</span>
                <span class="lot_name">Замовлення</span>
                <span class="lot_name">Місто</span>
                <span class="lot_name">Адреса</span>
                <span class="lot_name">Термін оплати</span>
    ...
    >
      ...
      <div class="lot_name">
        {{ order.partner_info.companyName }}
      </div>
      <div class="lot_name">
        {{ order.partner_info.phone }}
      </div>
      <div class="lot_name">
      ...
      <div class="lot_name">
        {{ order.partner_info.city }}
      </div>
      <div class="lot_name">
        {{ order.partner_info.address }}
      </div>
      <div class="lot_name">
        {{ order.partner_info.paymentTerms }}
      </div>
      <div class="lot_name">
        {{ order.author }}
      </div>
