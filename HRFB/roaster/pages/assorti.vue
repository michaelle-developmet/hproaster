...
<template>
  ...
  <div class="head_block">
        ...
        <div class="searching_plate">
            <Input style="padding: 1vw;margin: 1vw;" type="email" placeholder="Пошук товару" class="input_style" />
  ...
  <ScrollArea class="rounded-md border area">
    <div class="p-4 ">
      ...
      <div v-for="invoice in paginatedData" :key="invoice.lotId" class="uniq_position">
        ...
        <Dialog >
          <DialogTrigger as-child>
            <Button variant="outline" @click="openInvoiceInfo(invoice)" class="btn_info">
              <Info />
            </Button>
          </DialogTrigger>
